...
const AddSpecification = () => {
    ...
    const handelRemoveSpec = (index:number)=>setSpecifications(specifications.filter((_,idx)=>index  !== idx));
    ...
    <div className="p-3 mt-3  border-2 border-white/20 rounded-lg    space-y-3">
      <form ref={ref} onSubmit={handelAddSpec}>
        ...
        <div className="mt-3 text-end">
          <button type='submit' className="text-primary font-medium">Add</button>
        </div>
      </form>
      <div>
          ...
          {specifications.map((_, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2 text-sm">
                <button onClick={()=>handelRemoveSpec(index)} className="text-info font-medium">Remove</button>
